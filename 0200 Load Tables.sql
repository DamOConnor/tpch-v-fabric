...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/customer.tbl'
WITH (
    FILE_TYPE = 'CSV',
    --CREDENTIAL = ( IDENTITY = 'Managed Identity' ),
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
);


COPY INTO dbo.lineitem
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/lineitem.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/nation.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/orders.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
COPY INTO dbo.part
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/part.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/partsupp.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/region.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
...
FROM 'https://strgfabriclanding.blob.core.windows.net/datalake/raw/tpc-h/scale1/csv/supplier.tbl'
WITH (
    FILE_TYPE = 'CSV',
    CREDENTIAL = ( IDENTITY= 'Shared Access Signature', SECRET = '<sas key>' ),
    FIELDTERMINATOR = '|'
